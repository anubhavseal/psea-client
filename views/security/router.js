angular.module('security').
	config(['$routeProvider', '$locationProvider', '$httpProvider', 'adalAuthenticationServiceProvider', '$constants', function($routeProvider, $locationProvider, $httpProvider, adalProvider, $constants) {
		var o365Config = null;
		
		angular.forEach($constants.SupportedAuthentications || [], function(authType) {
			if (authType.type != null && authType.type.toUpperCase() == 'O365') {
				o365Config = authType.config;
			}
		});
